...
const DedicatedSection = () => {
    ...
    return (
        <section className="text-blueGray-700 bg-bgNav pt-16">
            <div className="container flex flex-col items-center px-5 pb-8 mx-auto">
            ...
            <div className="container items-center px-5 mx-auto lg:px-28">
                <div className="flex flex-wrap justify-center">
                    <div data-aos="fade-right" className=" w-full lg:w-1/2 hover:animate-bounce">
                        <div className="p-8">
                    ...
                    <div data-aos="fade-left" className="animate__animated animate__bounce animate__delay-2s w-full lg:w-1/2">
                        <div className="p-8">
